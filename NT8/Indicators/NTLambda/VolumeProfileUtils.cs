...
{
    #region Data
    internal class NTLVolumeProfileRow
    {
        public long buy = 0;
        public long sell = 0;
        public long other = 0;
    ...
    internal class NTLVolumeProfileData : ConcurrentDictionary<double, NTLVolumeProfileRow>
    {
        ...
        public NTLVolumeProfileRow UpdateRow(double price, long buyVolume, long sellVolume, long otherVolume)
        {
            var row = AddOrUpdate(
                price,
                (double key) => new NTLVolumeProfileRow()
                {
                    buy = buyVolume,
                    sell = sellVolume,
                    other = otherVolume
                },
                (double key, NTLVolumeProfileRow oldValue) => new NTLVolumeProfileRow()
                {
        ...
        public NTLVolumeProfileRow GetValueOrDefault(double price)
        {
            NTLVolumeProfileRow volume;
            if (!TryGetValue(price, out volume))
            {
                volume = new NTLVolumeProfileRow();
            }
            return volume;
        }
    }
    ...
    internal class NTLVolumeProfileChartRenderer
    {
        ...
        public NTLVolumeProfileChartRenderer(
        ...
        internal SharpDX.RectangleF GetBarRect(
            NTLVolumeProfileData profile, double price, long volume,
        ...
        internal void RenderProfile(NTLVolumeProfileData profile, Brush volumeBrush)
        {
            foreach (KeyValuePair<double, NTLVolumeProfileRow> row in profile)
            {
        ...
        internal void RenderPoc(NTLVolumeProfileData profile, Brush brush, float width, StrokeStyle strokeStyle, bool drawText = false)
        {
        ...
        internal void RenderValueArea(NTLVolumeProfileData profile, Brush brush, float width, StrokeStyle strokeStyle, bool drawText = false)
        {
            // draw VAH
        ...
        internal void RenderBuySellProfile(NTLVolumeProfileData profile, Brush buyBrush, Brush sellBrush)
        {
            foreach (KeyValuePair<double, NTLVolumeProfileRow> row in profile)
            {
        ...
        internal void RenderDeltaProfile(NTLVolumeProfileData profile, Brush buyBrush, Brush sellBrush)
        {
            foreach (KeyValuePair<double, NTLVolumeProfileRow> row in profile)
            {
        ...
        internal void RenderTotalVolume(NTLVolumeProfileData profile, Brush textBrush)
        {
    ...
    public enum NTLVolumeProfileMode { Standard, BuySell, Delta };
    public enum NTLVolumeProfilePeriod { Sessions, Bars };
    public enum NTLVolumeProfileResolution { Tick, Minute };
}
